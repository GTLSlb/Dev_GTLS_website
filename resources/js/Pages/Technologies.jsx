                ...
                <div className="relative isolate overflow-hidden  py-16 sm:py-16 mb-10">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="relative lg:order-last lg:col-span-5">
                            ...
                            <p className="mt-3 text-smooth">
                            We use leading technologies throughout our operations, from track-and-trace through to RF scanning and JAIX logistics software. We can also integrate our system with our customers’ system, enabling you to see the same data that we do. We can provide all kinds of reporting including on-time performance, DIFOT, GTLS Reporting Solution and KPI reporting.
                            </p>
                            <p className="mt-3 text-smooth">
