...
export default function Capability(props) {
    ...
    const [getCapability, setCapability] = useState([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const capabilityReq = await getFromStrapi(
                    `/api/capability-statement?pLevel=4`
                );
                ...
                <MainLayout loading={loading}>
                    ...
                    <div className="relative isolate bg-dark">
                        <div aria-hidden="true" className="relative">
                            <img
                                src={
                                    strapiApiUrl + getCapability.HeroSection.url
                                }
                                alt="jobs"
