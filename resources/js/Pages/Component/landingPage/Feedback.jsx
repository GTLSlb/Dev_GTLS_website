...
function Feedback() {
    ...
    const handleSubmit = (e) => {
        ...
        formData.append("feedbackValue", emoji);
        formData.append("feedbackMsg", additionalFeedback);
        axios
                ...
                <>
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="">
                            {!emoji ? (
                                <p className="text-center text-gray-600 px-10 my-5">
                                    How likely would you be to recommend Gold
                                    Tiger Group of Companies website's to a
                                    colleage?
                                </p>
                            ) : (
                                <p></p>
