                            ...
                            <tr>
                                <td className=" px-4 py-10 w-4/12">
                                    ...
                                    <h2 className="text-4xl font-bold tracking-tight text-dark">
                                        ...
                                        <div className="mt-2 text-lg  text-gray-600" dangerouslySetInnerHTML={{ __html: getcertificates?.description }}></div>
                                        ...
                                        <div className="absolute w-full flex gap-x-20 -translate-y-2/4 ">
                                            {getcertificates?.elements?.map((feature) => (
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() =>
                                                        handleImageClick("/app/webimages/"+feature.image)
                                                    }
                                                    aria-label="zoom"
