    ...
    return (
        <>
            ...
            {!loading ? (
                ...
                <div className="md:py-[8rem] px-5 mx-auto h-full rounded-lg">
                        ...
                        <div className="flex-grow flex flex-row-reverse">
                            ...
                            <div className="h-full w-80 bg-[#2A3034] p-4 pr-2 overflow-y-auto">
                                {markerDetails ? (
                                    ...
                                    <>
                                        <p className="text-3xl text-goldt">
                                            Filter
                                        </p>
                                        {/*  States Filter */}
